...
regeneratorRuntime.mark(function _callee() {
  var baseMapLayer, map, marker, vectorSource, markerVectorLayer;
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          marker = new ol.Feature({
            geometry: new ol.geom.Point(ol.proj.fromLonLat([-74.006, 40.7127])) // Coordinates of New York's Town Hall
